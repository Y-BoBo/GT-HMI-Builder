...
void Refresh_New_Page(unsigned char *data)
{
	...
	{
    gt_player_set_index(player1,data[1]); //设置player1的索引，左侧温度档位图标  1-5
		gt_player_set_index(player2,data[2]); //设置player2的索引，右侧温度档位图标  1-5
		gt_player_set_index(player3,data[3]); //设置player3的索引，左侧温度数字图标  1-5
		gt_player_set_index(player4,data[4]); //设置player4的索引，右侧温度数字图标  1-5
		gt_player_set_index(player5,data[5]); //设置player5的索引，中部数值          1-11 
...
void send_pack(void)
{
	...
	buf[0] = 0xaa;//包头
	buf[1] = gt_player_get_index(player1);//左侧温度档位图标  1-5
	buf[2] = gt_player_get_index(player2);//右侧温度档位图标  1-5
	buf[3] = gt_player_get_index(player3);//左侧温度数字图标  1-5
	buf[4] = gt_player_get_index(player4);//右侧温度数字图标  1-5
	buf[5] = gt_player_get_index(player5);//中部数值          1-11
	buf[6] = 8;//长度
...
gt_obj_st * gt_init_screen_home(void)
{
	...
	gt_img_set_src(img1, "f:img_800x480_bjcz.png");
	...
	gt_img_set_src(img3, "f:img_9x9_15_9x9752x28.png");
	...
	gt_imgbtn_set_src(imgbtn1, "f:img_34x34_19_34x3453x95.png");
	gt_imgbtn_set_src_press(imgbtn1, "f:img_34x34_19_p.png");
	...
	gt_imgbtn_set_src(imgbtn2, "f:img_34x34_19_34x3453x95.png");
	gt_imgbtn_set_src_press(imgbtn2, "f:img_34x34_19_p.png");
	...
	gt_imgbtn_set_src(imgbtn4, "f:img_9x9_17_9x9109x28.png");
	...
	gt_imgbtn_set_src(imgbtn5, "f:img_34x34_20_34x3453x382.png");
	gt_imgbtn_set_src_press(imgbtn5, "f:img_34x34_20_p.png");
	...
	gt_imgbtn_set_src(imgbtn6, "f:img_34x34_20_34x3453x382.png");
	gt_imgbtn_set_src_press(imgbtn6, "f:img_34x34_20_p.png");
	...
	gt_imgbtn_set_src(imgbtn7, "f:img_84x63_1_84x63122x417.png");
	gt_imgbtn_set_src_press(imgbtn7, "f:img_84x63_1_p.png");
	...
	gt_imgbtn_set_src(imgbtn8, "f:img_84x63_2_84x63219x417.png");
	gt_imgbtn_set_src_press(imgbtn8, "f:img_84x63_2_p.png");
	...
	gt_imgbtn_set_src(imgbtn9, "f:img_84x63_3_84x63316x417.png");
	gt_imgbtn_set_src_press(imgbtn9, "f:img_84x63_3_p.png");
	...
	gt_imgbtn_set_src(imgbtn10, "f:img_84x63_4_84x63412x417.png");
	gt_imgbtn_set_src_press(imgbtn10, "f:img_84x63_4_p.png");
	...
	gt_imgbtn_set_src(imgbtn11, "f:img_84x63_5_84x63507x417.png");
	gt_imgbtn_set_src_press(imgbtn11, "f:img_84x63_5_p.png");
	...
	gt_imgbtn_set_src(imgbtn12, "f:img_34x34_27_34x34383x277.png");
	gt_imgbtn_set_src_press(imgbtn12, "f:img_34x34_27_p.png");
	...
	gt_imgbtn_set_src(imgbtn13, "f:img_34x34_26_34x34383x167.png");
	gt_imgbtn_set_src_press(imgbtn13, "f:img_34x34_26_p.png");
	...
	gt_player_add_item(player1, "f:img_100x261_wdl_0.png", sizeof("f:img_100x261_wdl_0.png"));
	gt_player_add_item(player1, "f:img_100x261_wdl_1.png", sizeof("f:img_100x261_wdl_1.png"));
	gt_player_add_item(player1, "f:img_100x261_wdl_2.png", sizeof("f:img_100x261_wdl_2.png"));
	gt_player_add_item(player1, "f:img_100x261_wdl_3.png", sizeof("f:img_100x261_wdl_3.png"));
	gt_player_add_item(player1, "f:img_100x261_wdl_4.png", sizeof("f:img_100x261_wdl_4.png"));
	gt_player_add_item(player1, "f:img_100x261_wdl_5.png", sizeof("f:img_100x261_wdl_5.png"));
	...
	gt_player_add_item(player2, "f:img_100x271_wdr_0.png", sizeof("f:img_100x271_wdr_0.png"));
	gt_player_add_item(player2, "f:img_100x271_wdr_1.png", sizeof("f:img_100x271_wdr_1.png"));
	gt_player_add_item(player2, "f:img_100x271_wdr_2.png", sizeof("f:img_100x271_wdr_2.png"));
	gt_player_add_item(player2, "f:img_100x271_wdr_3.png", sizeof("f:img_100x271_wdr_3.png"));
	gt_player_add_item(player2, "f:img_100x271_wdr_4.png", sizeof("f:img_100x271_wdr_4.png"));
	gt_player_add_item(player2, "f:img_100x271_wdr_5.png", sizeof("f:img_100x271_wdr_5.png"));
	...
	gt_player_add_item(player3, "f:img_59x30_18_59x3045x33.png", sizeof("f:img_59x30_18_59x3045x33.png"));
	gt_player_add_item(player3, "f:img_59x30_20_59x3045x33.png", sizeof("f:img_59x30_20_59x3045x33.png"));
	gt_player_add_item(player3, "f:img_59x30_23_59x3045x33.png", sizeof("f:img_59x30_23_59x3045x33.png"));
	gt_player_add_item(player3, "f:img_59x30_26_59x3045x33.png", sizeof("f:img_59x30_26_59x3045x33.png"));
	gt_player_add_item(player3, "f:img_59x30_29_59x3045x33.png", sizeof("f:img_59x30_29_59x3045x33.png"));
	gt_player_add_item(player3, "f:img_59x30_32_59x3045x33.png", sizeof("f:img_59x30_32_59x3045x33.png"));
	...
	gt_player_add_item(player4, "f:img_59x30_18_59x3045x33.png", sizeof("f:img_59x30_18_59x3045x33.png"));
	gt_player_add_item(player4, "f:img_59x30_20_59x3045x33.png", sizeof("f:img_59x30_20_59x3045x33.png"));
	gt_player_add_item(player4, "f:img_59x30_23_59x3045x33.png", sizeof("f:img_59x30_23_59x3045x33.png"));
	gt_player_add_item(player4, "f:img_59x30_26_59x3045x33.png", sizeof("f:img_59x30_26_59x3045x33.png"));
	gt_player_add_item(player4, "f:img_59x30_29_59x3045x33.png", sizeof("f:img_59x30_29_59x3045x33.png"));
	gt_player_add_item(player4, "f:img_59x30_32_59x3045x33.png", sizeof("f:img_59x30_32_59x3045x33.png"));
	...
	gt_player_add_item(player5, "f:img_32x17_1_32x17.png", sizeof("f:img_32x17_1_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_2_32x17.png", sizeof("f:img_32x17_2_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_3_32x17.png", sizeof("f:img_32x17_3_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_4_32x17.png", sizeof("f:img_32x17_4_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_5_32x17.png", sizeof("f:img_32x17_5_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_6_32x17.png", sizeof("f:img_32x17_6_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_7_32x17.png", sizeof("f:img_32x17_7_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_8_32x17.png", sizeof("f:img_32x17_8_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_9_32x17.png", sizeof("f:img_32x17_9_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_10_32x17.png", sizeof("f:img_32x17_10_32x17.png"));
	gt_player_add_item(player5, "f:img_32x17_11_32x17.png", sizeof("f:img_32x17_11_32x17.png"));
	...
	gt_player_add_item(player6, "f:img_174x258_zyl_1.png", sizeof("f:img_174x258_zyl_1.png"));
	gt_player_add_item(player6, "f:img_174x258_zyl_2.png", sizeof("f:img_174x258_zyl_2.png"));
	...
	gt_player_add_item(player8, "f:img_174x258_zyr_1.png", sizeof("f:img_174x258_zyr_1.png"));
	gt_player_add_item(player8, "f:img_174x258_zyr_2.png", sizeof("f:img_174x258_zyr_2.png"));
	...
	gt_imgbtn_set_src(imgbtn14, "f:img_84x63_6_p.png");
	gt_imgbtn_set_src_press(imgbtn14, "f:img_84x63_6_83x63603x417.png");
